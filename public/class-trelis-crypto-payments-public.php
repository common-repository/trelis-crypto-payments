 ...
 * @subpackage Trelis_Crypto_Payments/public
 */
 ...
 */
class Trelis_Crypto_Payments_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/trelis-crypto-payments-public.js', array( 'jquery' ), $this->version, false );
